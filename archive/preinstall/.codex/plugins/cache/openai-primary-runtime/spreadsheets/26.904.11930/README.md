...
This plugin package is generated from `lib/artifacts/artifacts_skills` and copied into `plugins/spreadsheets` through `lib/artifacts/artifacts_skills/mapping.json`.
