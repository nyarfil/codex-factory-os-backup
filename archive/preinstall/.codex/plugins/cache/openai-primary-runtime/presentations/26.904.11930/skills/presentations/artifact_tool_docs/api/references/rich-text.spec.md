...
shape.text.set([
  ...
  {
    bulletCharacter: "•",
    marginLeft: 18 * 12700, // points to EMU
    indent: -10 * 12700,
    runs: [
      "Open the",
      {
...
The paragraph-object form is the non-JSX peer of `<paragraph>...</paragraph>`. Use it when the text needs paragraph metadata plus authored runs. In the verified runtime, indentation is EMU and paragraph spacing is hundredths of a point, unlike shape-level pixel sizes. See [native bullets](../../../references/native_bullets.md) for the point-based helper and serialization checks.
...
shape.text.set([
  { bulletCharacter: "•", marginLeft: 22 * 12700, indent: -12 * 12700, runs: [{ run: "Quality:", textStyle: { bold: true } }, " defect rate down 31%"] },
  { bulletCharacter: "•", marginLeft: 22 * 12700, indent: -12 * 12700, runs: [{ run: "Speed:", textStyle: { bold: true } }, " p95 latency under target"] },
]);
```
