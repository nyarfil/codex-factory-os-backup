...
Pluginの `.mcp.json` が `http://127.0.0.1:27182/mcp` をHTTP MCPとして提供する。Fusion起動中かつ Preferences > General > API のFusion MCP Serverが有効な間だけ利用可能。新しいPlugin/ツールの認識は新規Codexセッションで確認する。
