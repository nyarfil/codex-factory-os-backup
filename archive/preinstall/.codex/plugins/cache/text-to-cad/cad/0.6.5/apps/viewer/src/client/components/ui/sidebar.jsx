  ...
  return (
    <div
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) shrink-0 bg-transparent",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 flex h-svh w-(--sidebar-width) shrink-0",
          side === "left"
...
function SidebarMenuSub({
  ...
  return (
    <ul
      ...
      className={cn(
        "mx-2 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border px-2 py-1",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props} />
