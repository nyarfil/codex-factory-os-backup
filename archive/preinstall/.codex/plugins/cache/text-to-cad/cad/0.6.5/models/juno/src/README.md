...
|---|---|---|
| juno.py | STEP/juno.step | Full 28-occurrence humanoid assembly, 27 revolute mates + 5 pose presets, embedded choreography |
...
`ANIMATION_JS` in `juno.py` is embedded in model metadata for the viewer.
