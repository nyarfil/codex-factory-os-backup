...
bodies=[];evidence={}
for stem in ('compact_mcp_dorsal',):
...
rigid=rigid_audit(bodies,ROOT/'compact_mcp_dorsal_mutual.json')
...
for sample in manifest['rows']:
 ...
 (ROOT/'compact_mcp_dorsal_routes.json').write_text(json.dumps(report,indent=2)+'\n')
