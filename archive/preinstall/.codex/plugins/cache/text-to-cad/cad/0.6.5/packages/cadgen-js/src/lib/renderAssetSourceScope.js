...
// from an already-resolved absolute path), and cadgen-js already reads the same field for
...
// docs/viewer shape documented in packages/cadgen-js/docs/render-pipeline.md — renders one source per
