...
`ANIMATION_JS` literal below; edit the choreography there.
"""
...
ANIMATION_JS = r'''// Articulation choreography for the lyra dexterous hand.
//
...
@step(out="../STEP/lyra.step", kinematics=KINEMATICS, animation=ANIMATION_JS)
def lyra():
    return assemble()
