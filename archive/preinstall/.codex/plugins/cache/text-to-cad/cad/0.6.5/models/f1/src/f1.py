...
--------------------------------------------------------------------------
The embedded `ANIMATION_JS` source addresses children as `#o1.N` in the
...
ANIMATION_JS = r'''// Choreography for the F1 concept car.
//
...
@step(out="../STEP/f1.step", animation=ANIMATION_JS)
def f1():
    return assemble()
