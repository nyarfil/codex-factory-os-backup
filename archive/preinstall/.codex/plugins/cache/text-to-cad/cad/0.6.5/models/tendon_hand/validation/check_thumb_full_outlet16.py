...
_candidate_atlas=json.loads(Path('models/tendon_hand/validation/thumb_cmc_outlet16_axes.json').read_text())+json.loads(Path('models/tendon_hand/validation/thumb_cmc_outlet16_topflex.json').read_text())
...
if __name__=='__main__':
    ...
    samples=[('neutral',{}),('cmc_yaw45',{'thumb_cmc_abduction':45.}),('cmc_flex50',{'thumb_cmc_flexion':50.})]
