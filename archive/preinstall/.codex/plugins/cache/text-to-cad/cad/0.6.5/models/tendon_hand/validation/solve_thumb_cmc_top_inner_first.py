...
for f in(65.,):
 ...
 for lane in(-3.,3.,-4.2,4.2,-5.4,5.4):
 ...
 previous={'flex':f,'yaw':0.,'outlet_y':16,'rows':rows};out.append(previous);(root/'thumb_cmc_top_inner_first.json').write_text(json.dumps(out,indent=2))
