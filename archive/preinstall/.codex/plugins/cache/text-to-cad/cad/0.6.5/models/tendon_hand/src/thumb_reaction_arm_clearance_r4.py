...
PATHS = [[[-0.62, -3.275, -7.9], [1.8, -3.275, -7.9], [-1.4239150568688284, 8.075423574700105, -7.9], [-1.4239150568688284, 8.075423574700105, -10.2]], [[-1.4239150568688284, 8.075423574700105, -10.2], [-1.4239150568688284, 8.075423574700105, -11.4], [-1.4239150568688284, 8.075423574700105, -12.6], [-1.4239150568688284, 8.075423574700105, -13.8]], [[-1.4239150568688284, 8.075423574700105, -13.8], [-1.4239150568688284, 8.075423574700105, -16.1], [1.8, -3.5, -16.9], [0.4, -3.5, -15.2]]]

@step(out='../STEP/thumb_reaction_arm_clearance_r4.step')
def thumb_reaction_arm_clearance_r4():
    ...
    (ROOT/'validation/thumb_reaction_arm_clearance_r4_build.json').write_text(json.dumps(report,indent=2)+'\n')
    return bd.Compound(label='context_clearance_reaction_arm_R4',children=[shape])

if __name__=='__main__':thumb_reaction_arm_clearance_r4()
