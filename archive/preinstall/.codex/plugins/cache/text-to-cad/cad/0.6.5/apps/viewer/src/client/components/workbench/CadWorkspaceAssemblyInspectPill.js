  ...
  return (
    ...
    >
      <Button
        ...
        variant="outline"
        size="sm"
        className="bg-popover pointer-events-auto max-w-[min(32rem,calc(100vw-6rem))] rounded-full px-3 py-1.5 text-[12px] font-medium text-popover-foreground shadow-sm"
        onClick={onExit}
