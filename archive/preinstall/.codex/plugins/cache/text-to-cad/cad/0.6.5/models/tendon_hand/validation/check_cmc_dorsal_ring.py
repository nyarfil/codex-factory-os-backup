...
rigid=rigid_audit(bodies,ROOT/'cmc_dorsal_ring_mutual.json')
...
for sample in manifest['rows']:
 ...
 (ROOT/'cmc_dorsal_ring_routes.json').write_text(json.dumps(report,indent=2)+'\n')
