"""All48 actual payout routes against the R5 native thumb arm at225 poses."""
...
PREFIX='thumb_arm_r5_all_tendons'
def partition(index):
...
def main():
    ...
    path=HERE.parents[0]/'STEP/thumb_reaction_arm_clearance_r5.step';name='thumb_cmc_negative_yaw_outlet_structural_jaw_1'
