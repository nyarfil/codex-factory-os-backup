...
Use this reference for standalone validation requests, explicit heavy/deep/comprehensive reviews, or an accepted deep-review offer. Explicit normal review and validation inside another skill use the standard workflow in [validate-data](../GUIDE.md). Heavy review covers analytical trust and the artifact's usefulness, completeness and presentation, concentrating depth on what could change a decision.
