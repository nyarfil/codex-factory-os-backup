...
- **Substantive domain definitions:** Put definitions, source inventory, and necessary query/join notes under Data Context in the same GUIDE.md as any working guidance for that audience. Use the reference's category tables with lower-level headings and no second frontmatter block.
...
For context needed only by today’s analysis, use [gather-business-context](../gather-business-context/GUIDE.md).
