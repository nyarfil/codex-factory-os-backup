...
Use [$visualize-data](../visualize-data/GUIDE.md) for chart selection, analytical integrity, and visual QA when building notebook figures. Keep figures in notebook cell outputs using the notebook's plotting tools.
