...
| Reusable Data context authoring, review, and packaging | [create-data-context](skills/create-data-context/GUIDE.md) |
| Report analysis, composition, and next-step selection | [build-report](skills/build-report/GUIDE.md) |
| Report wording and presentation examples | [narrative-style](skills/build-report/references/narrative-style.md) |
| Dashboard composition and monitoring behavior | [build-dashboard](skills/build-dashboard/GUIDE.md) |
| Chart selection, contextual annotations, and visual QA | [visualize-data](skills/visualize-data/GUIDE.md) |
| Notebook structure, visual presentation, and execution | [jupyter-notebooks](skills/jupyter-notebooks/GUIDE.md) |
| Requested analysis reviews, verified important repairs, and audit-only assessments | [validate-data](skills/validate-data/GUIDE.md) |
