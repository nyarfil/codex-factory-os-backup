...
Complete these steps before following the [Quickstart](../GUIDE.md).
...
- Hardware requirements are the same as the [Quickstart](../GUIDE.md).
...
If you prepared Windows manually, open a WSL terminal (type `wsl` in PowerShell, or open Ubuntu from Windows Terminal) and continue with the [Quickstart](../GUIDE.md) to install NemoClaw and launch your first sandbox.
