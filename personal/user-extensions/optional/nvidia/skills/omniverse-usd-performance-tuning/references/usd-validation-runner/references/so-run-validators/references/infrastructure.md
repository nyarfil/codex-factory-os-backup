...
- Package path: `.agents/skills/validators/GUIDE.md`
- Upstream web URL: [https://github.com/NVIDIA-omniverse/usd-optimize/blob/main/.agents/skills/validators/GUIDE.md](https://github.com/NVIDIA-omniverse/usd-optimize/blob/main/.agents/skills/validators/GUIDE.md)

Resolve the upstream guide without cloning the source repo:

1. `$SCENE_OPTIMIZER_PACKAGE_ROOT/.agents/skills/validators/GUIDE.md`
2. `$SO_HOME/.agents/skills/validators/GUIDE.md`
