...
- Package operation runner skill: `.agents/skills/run-operations/GUIDE.md`
- Package validator runner skill: `.agents/skills/run-validators/GUIDE.md`
- Package validator interpretation skill: `.agents/skills/interpret-validators/GUIDE.md`
- Package proxy skill: `.agents/skills/create-proxy/GUIDE.md`
- Package install skill: `.agents/skills/prebuilt-package/GUIDE.md`
