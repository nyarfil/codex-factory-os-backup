...
- Video Data Augmentation: use `skills/physical-ai-video-data-augmentation/GUIDE.md`.
- Defect Image Generation: use `skills/physical-ai-defect-image-generation/GUIDE.md`.
- NuRec carline adaptation: use `skills/carline-adaptation/GUIDE.md`.
