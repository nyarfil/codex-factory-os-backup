...
```bash
cat "$UPSTREAM_ROOT/nurec-skills/.agents/skills/GUIDE.md"          # router
cat "$UPSTREAM_ROOT/nurec-skills/.agents/skills/<folder>/GUIDE.md" # sibling
```
...
<https://github.com/NVIDIA/nurec-skills/blob/main/.agents/skills/GUIDE.md>
