...
- Upstream CAD conversion skill: `https://github.com/NVIDIA-Omniverse/usd-convert-cad/blob/main/.agents/skills/usd-convert-cad/GUIDE.md`
...
`.agents/skills/usd-convert-cad/GUIDE.md`.
