...
`$SIMREADY_FOUNDATION_ROOT/skills/simready-foundation-conform-fet-004-simulate-multi-body-physics/GUIDE.md`
or
`$PHYSICAL_AI_SKILL_HUB_UPSTREAM_ROOT/simready-foundation/skills/simready-foundation-conform-fet-004-simulate-multi-body-physics/GUIDE.md`
