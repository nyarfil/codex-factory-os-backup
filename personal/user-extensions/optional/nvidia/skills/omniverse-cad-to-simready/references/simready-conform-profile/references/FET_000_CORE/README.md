...
`$SIMREADY_FOUNDATION_ROOT/skills/simready-foundation-conform-fet-000-core/GUIDE.md`
or
`$PHYSICAL_AI_SKILL_HUB_UPSTREAM_ROOT/simready-foundation/skills/simready-foundation-conform-fet-000-core/GUIDE.md`
