...
`$SIMREADY_FOUNDATION_ROOT/skills/simready-foundation-conform-fet-001-minimal/GUIDE.md`
or
`$PHYSICAL_AI_SKILL_HUB_UPSTREAM_ROOT/simready-foundation/skills/simready-foundation-conform-fet-001-minimal/GUIDE.md`
