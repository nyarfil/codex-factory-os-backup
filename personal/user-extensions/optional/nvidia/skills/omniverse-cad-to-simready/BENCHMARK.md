...
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`skills/omniverse-cad-to-simready/GUIDE.md`)
- LOW QUALITY/quality_correctness: No examples provided (`skills/omniverse-cad-to-simready/GUIDE.md`)
- LOW QUALITY/quality_discoverability: Description very long (422 chars, recommend 50-150) (`skills/omniverse-cad-to-simready/GUIDE.md`)
- LOW QUALITY/quality_discoverability: No '## Purpose' section (`skills/omniverse-cad-to-simready/GUIDE.md`)
